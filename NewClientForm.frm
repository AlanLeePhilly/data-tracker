...
Private Sub DiversionProgram_Change()
     Select Case DiversionProgram.value
        Case "No"
            DiversionProgramLabel.Enabled = False
        ...
        Case Else
            DiversionProgramLabel.Enabled = True
    ...
    On Error GoTo err
        ...
        Select Case InitialHearingLocation.value
            Case "4G", "4E", "6F", "6H", "3E"
                For i = 1 To 2
                    If i = 1 Then
                        bucketHead = hFind("Pretrial", "LEGAL STATUS", InitialHearingLocation.value)
                    Else
                        bucketHead = hFind("Pretrial", "LEGAL STATUS", "AGGREGATES")
                    End If
                    
                    Call startLegalStatus( _
                        clientRow:=emptyRow, _
                        bucketHead:=bucketHead, _
            ...
            Case "5E"
                Range(hFind("Legal Status") & emptyRow).value = Lookup("Legal_Status_Name")("Crossover")
        
            Case "JTC"
                Range(hFind("Legal Status") & emptyRow).value = Lookup("Legal_Status_Name")("JTC")

            Case "WRAP"
                Range(hFind("Legal Status") & emptyRow).value = Lookup("Legal_Status_Name")("WRAP")

            Case "Adult"
                Range(hFind("Legal Status") & emptyRow).value = Lookup("Legal_Status_Name")("Adult")
            
            Case Else
                Range(hFind("Legal Status") & emptyRow).value = Lookup("Legal_Status_Name")("Unknown")
        ...
        If IntakeConferenceRecord.value = "Yes" Then
...
Private Sub TestFillPetition_Click()
    ...
    InitialHearingDate.value = "07/01/2017"
...
Private Sub TestFillDiversion_Click()
    ...
    NameOfProgram.value = "YAP"
    YAPDistrict.value = 2
    IntakeConferenceRecord.value = "No"
...
Private Sub TestFillIntake_Click()
    ...
    IntakeConferenceRecord.value = "Yes"
    InConfType.value = "DA"
