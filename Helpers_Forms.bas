...
Sub RearrestIntake(userRow As Long, rearrestNum As Long)
    ...
    With NewClientForm
        ...
        'TimeOfArrest_H.value =
        'TimeOfArrest_M.value =
        'TimeOfArrest_P.value =
        ...
        .ActiveAtArrest.value = Lookup("Generic_YNOU_Num")(Range(headerFind("Active in System at Time of Arrest?") & userRow))
