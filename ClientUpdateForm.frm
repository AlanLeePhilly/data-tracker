    ...
    On Error GoTo err
        ...
        If Standard_Legal_Status_Update.BackColor = selectedColor Then
            With Modal_Standard_Legal_Status
                ...
                Select Case .Current_Legal_Status
                    Case "Pretrial", "Consent Decree", "Interim Probation", "Probation", "Aftercare Probation"
                        For i = 1 To 2
                            If i = 1 Then
                                bucketHead = headerFind(.Current_Legal_Status, headerFind("LEGAL STATUS", oldCourtHead))
                            Else
                                bucketHead = hFind(.Current_Legal_Status, "LEGAL STATUS", "AGGREGATES")
                            End If
                ...
                Select Case .New_Legal_Status
                    Case "Pretrial", "Consent Decree", "Interim Probation", "Probation", "Aftercare Probation"
                        For i = 1 To 2
                            If i = 1 Then
                                bucketHead = headerFind(.New_Legal_Status, headerFind("LEGAL STATUS", newCourtHead))
                            Else
                                bucketHead = hFind(.New_Legal_Status, "LEGAL STATUS", "AGGREGATES")
                            End If
                        ...
                        Next i
                    Case Else
                        Range(hFind("Legal Status") & updateRow).value = Lookup("Legal_Status_Name")(.Current_Legal_Status)
                End Select
            End With
        End If
